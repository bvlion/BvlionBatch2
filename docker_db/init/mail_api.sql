...
(
    ...
    channel VARCHAR(256) NOT NULL COMMENT 'slack のチャンネル',
    user_name VARCHAR(256) NOT NULL COMMENT 'slack のユーザー名',
    icon_url VARCHAR(256) NOT NULL COMMENT 'slack の icon url',
